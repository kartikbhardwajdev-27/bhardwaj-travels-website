...
import {
  Plane, Car, MapPin, Briefcase, Heart, Building2,
...
const services = [
  {
    ...
    description: "Smooth, on-time airport transfers between Mohali and Chandigarh International Airport.",
  },
  {
    icon: Building2,
    title: "IT Park Cab Service",
    description: "Daily office commutes and employee shuttles for IT companies in Mohali Sectors 66–74.",
  },
  {
    icon: MapPin,
    title: "Outstation from Mohali",
    description: "Comfortable one-way and round trips to Shimla, Manali, Amritsar, and across North India.",
  },
  {
    icon: Briefcase,
    title: "Corporate Cab Service",
    description: "Dedicated executive travel and employee transport solutions for businesses in Mohali.",
  },
  {
    icon: Car,
    title: "Local City Taxi in Mohali",
    description: "Quick and reliable local cab service across all sectors of Mohali — available 24/7.",
  },
  {
    icon: Heart,
    title: "Wedding Fleet Mohali",
    description: "Luxury wedding cars and group vehicles for celebrations across Mohali and SAS Nagar.",
  },
];
...
const whyUs = [
  {
    ...
    description: "Two decades of trusted taxi and travel service across the Tricity and North India.",
  },
  {
    icon: ShieldCheck,
...
const fleet = [
  {
    ...
    alt: "Sedan – Swift Dzire / Honda Amaze available in Mohali",
  },
  {
    type: "SUV",
    capacity: "6 passengers",
    image: "/images/fleet/suv-1.jpg",
    alt: "SUV – Innova Crysta, Ertiga, KIA Carens available in Mohali",
  },
  {
    type: "Premium",
    capacity: "4 passengers",
    image: "/images/fleet/premium-1.jpg",
    alt: "Premium – Mercedes E-Class / BMW 5 Series / Audi A6 in Mohali",
  },
  {
    type: "Tempo Traveller",
    capacity: "12–16 passengers",
    image: "/images/fleet/tempo-1.jpg",
    alt: "Tempo Traveller for group travel from Mohali",
  },
];

export default function MohaliTaxiContent() {
  return (
    <div>
      {/* Hero */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 text-center">
          ...
          >
            <span className="inline-block bg-primary/10 text-primary text-sm font-semibold px-4 py-1.5 rounded-full mb-6 border border-primary/20">
              Mohali · Available 24/7
            </span>
            <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground mb-6 leading-tight">
              Taxi Service in<br />
              <span className="text-primary">Mohali</span>
            </h1>
            <p className="text-muted text-xl max-w-2xl mx-auto mb-10">
              24/7 cab service for IT park commutes, airport transfers, outstation trips and more — serving Mohali, SAS Nagar and the Tricity area.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-4">
              Our Services in Mohali
            </h2>
            <p className="text-muted max-w-xl mx-auto">
              From IT commutes to mountain getaways, we have the right cab for every trip in Mohali.
            </p>
          </motion.div>
      ...
      <section className="py-20 sm:py-28 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            Why Mohali Chooses Bhardwaj Travels
          </motion.h2>
          ...
          >
            <div>
              ...
              <p className="text-muted max-w-md">
                Sedans for quick commutes, SUVs for families, premium cars for executives, tempo travellers for groups.
              </p>
            </div>
            <Link href="/fleet">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 sm:py-32">
          ...
          >
            <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-black mb-4">
              Book Your Mohali Taxi Now
            </h2>
            <p className="text-black/70 text-xl mb-8 max-w-2xl mx-auto">
              On-time pickups, expert drivers, and transparent fares — trusted across Mohali.
            </p>
            <Link href="/contact">
