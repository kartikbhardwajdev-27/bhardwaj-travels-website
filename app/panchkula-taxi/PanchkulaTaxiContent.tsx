...
const services = [
  {
    ...
    description: "On-time airport transfers between Panchkula and Chandigarh International Airport.",
  },
  {
    icon: Car,
    title: "Local City Taxi in Panchkula",
    description: "Affordable and punctual cab service for all your local trips within Panchkula.",
  },
  {
    icon: MapPin,
    title: "Outstation from Panchkula",
    description: "One-way and round trips to Kasauli, Shimla, Manali, Haridwar, and destinations across North India.",
  },
  {
    icon: Briefcase,
    title: "Corporate Cab Service",
    description: "Seamless corporate travel for employees and executives based in Panchkula.",
  },
  {
    icon: Heart,
    title: "Wedding Fleet Panchkula",
    description: "Premium wedding cars and group vehicles to make every celebration in Panchkula unforgettable.",
  },
  {
    icon: Map,
    title: "Tour Packages from Panchkula",
    description: "Handcrafted tour packages covering Himachal Pradesh, Uttarakhand, and beyond.",
  },
];
...
const whyUs = [
  {
    ...
    description: "Over two decades of trusted travel service across the Tricity region and North India.",
  },
  {
    icon: ShieldCheck,
...
const fleet = [
  {
    ...
    alt: "Sedan – Swift Dzire / Honda Amaze available in Panchkula",
  },
  {
    type: "SUV",
    capacity: "6 passengers",
    image: "/images/fleet/suv-1.jpg",
    alt: "SUV – Innova Crysta, Ertiga, KIA Carens available in Panchkula",
  },
  {
    type: "Premium",
    capacity: "4 passengers",
    image: "/images/fleet/premium-1.jpg",
    alt: "Premium – Mercedes E-Class / BMW 5 Series / Audi A6 in Panchkula",
  },
  {
    type: "Tempo Traveller",
    capacity: "12–16 passengers",
    image: "/images/fleet/tempo-1.jpg",
    alt: "Tempo Traveller for group tours from Panchkula",
  },
];

export default function PanchkulaTaxiContent() {
  return (
    <div>
      {/* Hero */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 text-center">
          ...
          >
            <span className="inline-block bg-primary/10 text-primary text-sm font-semibold px-4 py-1.5 rounded-full mb-6 border border-primary/20">
              Panchkula · Available 24/7
            </span>
            <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground mb-6 leading-tight">
              Taxi Service in<br />
              <span className="text-primary">Panchkula</span>
            </h1>
            <p className="text-muted text-xl max-w-2xl mx-auto mb-10">
              24/7 cab service for airport transfers, outstation trips, local travel and more — serving Panchkula and the Tricity area.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-4">
              Our Services in Panchkula
            </h2>
            <p className="text-muted max-w-xl mx-auto">
              Whether it&apos;s a local run or a long outstation journey, we have the perfect cab for you.
            </p>
          </motion.div>
      ...
      <section className="py-20 sm:py-28 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            Why Choose Bhardwaj Travels in Panchkula
          </motion.h2>
          ...
          >
            <div>
              <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-3">
                Our Fleet in Panchkula
              </h2>
              <p className="text-muted max-w-md">
                Economy sedans, family SUVs, luxury cars, and group tempo travellers — all at your service.
              </p>
            </div>
            <Link href="/fleet">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 sm:py-32">
          ...
          >
            <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-black mb-4">
              Book Your Panchkula Taxi Now
            </h2>
            <p className="text-black/70 text-xl mb-8 max-w-2xl mx-auto">
              Punctual pickups, friendly drivers, and zero hidden costs — every single time.
            </p>
            <Link href="/contact">
